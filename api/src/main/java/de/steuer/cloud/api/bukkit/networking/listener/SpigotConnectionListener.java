package de.steuer.cloud.api.bukkit.networking.listener;
...
public class SpigotConnectionListener extends AbstractConnectionListener {

    private final Networking networking;
    private final String host;
    private final int port;

    public SpigotConnectionListener(final Networking networking, final String host, final int port) {
